...
class Attention(nn.Module):
    def __init__(self, dim, num_heads=8, qkv_bias=False, qk_scale=None, attn_drop=0.0, proj_drop=0.0, sr_ratio=1):
        super().__init__()
        assert dim % num_heads == 0, f"dim {dim} should be divided by " f"num_heads {num_heads}."
...
class DropPath(nn.Module):
    ...
    def drop_path(x, drop_prob: float = 0.0, training: bool = False, scale_by_keep: bool = True):
        ...
        I'veoptedforchanging the layer and argument names to 'drop path' rather than mix
