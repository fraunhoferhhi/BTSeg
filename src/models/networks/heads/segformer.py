...
model_urls = {
    "cityscapes": {
        "mit_b5": "./pretrained_weights/segformer.b5.1024x1024.city.160k.pth",
    }
}
    ...
    def init_weights(self):
        ...
        for m in self.modules():
            ...
            if isinstance(m, ConvBNReLU) and not m.depthwise_separable:
                nn.init.kaiming_normal_(m.conv.weight, a=0, mode="fan_out", nonlinearity="relu")
    ...
    def load_pretrained(self, pretrained):
        ...
        if os.path.exists(pretrained):
            ...
            checkpoint = torch.load(
                os.path.join(os.environ.get("TORCH_HOME", ""), "hub", pretrained),
        ...
        for k, v in state_dict.items():
            if k.startswith("decode_head."):
                ...
                pass
        new_state_dict = {k: v for k, v in new_state_dict.items() if not k.startswith("conv_seg.")}
